 ...
 *
 * `progress` = 0 da transformaciones a cero, así que servidor y cliente
 * hidratan igual tenga o no el visitante movimiento reducido; con movimiento
 * reducido las amplitudes son 0 y el fondo se queda quieto.
 */
